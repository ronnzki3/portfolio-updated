              ...
              <div className='bg-white flex flex-col w-full min-h-[350px] h-auto hover:scale-105 duration-300 shadow-xl'>
                ...
                <div className='bg-white flex flex-col w-full min-h-[350px] h-auto hover:scale-105 duration-300 shadow-xl'>
                  ...
                  <p className='font-medium text-lg'>Landing Page</p>
                    ...
                    <a className='text-xs text-white mx-auto inline-block py-3 px-7 bg-green-700 hover:bg-green-500 rounded-lg mt-5 mr-3' href="https://lv-upholstery.vercel.app/" target="_blank" rel="noreferrer">Visit</a>
                    <a className='text-xs text-white mx-auto inline-block py-3 px-5 bg-green-700 hover:bg-green-500 rounded-lg mt-5' href="https://github.com/ronnzki3/lv-upholstery-landing-page" target="_blank" rel="noreferrer">GitHub</a>
                  </div>
                </div>
                ...
                <div className='bg-white flex flex-col w-full min-h-[350px] h-auto hover:scale-105 duration-300 shadow-xl'>
                  ...
                  <p className='font-medium text-lg'>Dental Clinic's Online Appointment</p>
                    ...
                    <a className='text-xs text-white mx-auto inline-block py-3 px-7 bg-green-700 hover:bg-green-500 rounded-lg mt-5 mr-3' href="https://dlc-dental.42web.io/" target="_blank" rel="noreferrer">Visit</a>
                ...
                <div className='bg-white flex flex-col w-full min-h-[350px] h-auto hover:scale-105 duration-300 shadow-xl'>
                  ...
                  <p className='font-medium text-lg'>Online Auto-computed Installment</p>
                    ...
                    <a className='text-xs text-white mx-auto inline-block py-3 px-7 bg-green-700 hover:bg-green-500 rounded-lg mt-5 mr-3' href="https://flg-pricing.42web.io/" target="_blank" rel="noreferrer">Visit</a>
